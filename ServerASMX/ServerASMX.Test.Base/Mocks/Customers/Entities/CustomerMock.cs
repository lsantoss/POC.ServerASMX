...
namespace ServerASMX.Test.Base.Mocks.Customers.Entities
{
    ...
    {
        public static Customer GetCustomer1() => new Customer(1, "Lucas Santos", new DateTime(1995, 7, 14), EGender.Male, 1500.75m, true, DateTime.Now, null);
        public static Customer GetCustomer2() => new Customer(2, "Renato Silva", new DateTime(2020, 5, 20), EGender.Male, 10.12m, true, DateTime.Now, null);
